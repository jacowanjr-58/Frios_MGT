...
<div class="content-body default-height">
    ...
    <div class="container-fluid">
        ...
        <div class="form-head mb-4 d-flex flex-wrap align-items-center">
            ...
            <a href="{{ route('expense-category.create', ['franchise' => $franchiseeId]) }}" class="btn btn-primary btn-sm">
...
<script>
    $(document).ready(function() {
        $('#expense-category-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('expense-category', ['franchise' => $franchiseeId]) }}",
            columns: [
            ...
            language: {
                // Add any language customizations here
            },
