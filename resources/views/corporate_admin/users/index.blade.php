			...
			<div class="container-fluid">
				<div class="form-head mb-4 d-flex flex-wrap align-items-center">
					<div class="me-auto">
						...
						<p>User Management - Unassigned Users Only</p>
					</div>
				</div>
                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="mb-1 fs-12">Unassigned Users</p>
                                            <h3 class="mb-0 font-w600 fs-22">{{ $totalUsers }} Users</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="table-responsive rounded">
							<table id="users-table" class="table customer-table display mb-4 fs-14 card-table">
								<thead>
                                    <tr>
                                        <th>Name</th>
                                        <th>Email</th>
