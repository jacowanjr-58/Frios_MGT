                            ...
                            <div class="d-sm-flex d-block align-items-center">
                                <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="mb-1 fs-12">Total Roles</p>
                                        <h3 class="mb-0 font-w600 fs-22">{{ $totalRoles }} Roles</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive rounded">
                        <table id="roles-table" class="table customer-table display mb-4 fs-14 card-table">
                            <thead>
                                <tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="permissionsModalLabel">All Permissions</h5>
            ...
            $(document).ready(function () {
                $('#roles-table').DataTable({
                    ...
                    columns: [
                        ...
                        { data: 'permissions_display', name: 'permissions_display' },
            ...
            function showAllPermissions(roleId) {
                fetch(`/corporate-admin/roles/${roleId}/permissions`)
                    ...
                    .then(data => {
                        ...
                        document.getElementById('permissionsModalLabel').textContent = `All Permissions for ${data.role}`;
