                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="basic-form">
                                            ...
                                            <form action="{{ route('franchise.update', $franchise->id) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="business_name"
                                                                value="{{ old('business_name', $franchise->business_name) }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="contact_number"
                                                                value="{{ old('contact_number', $franchise->contact_number) }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                value="{{ old('frios_territory_name', $franchise->frios_territory_name) }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="address1"
                                                                value="{{ old('address1', $franchise->address1) }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="address2"
                                                                value="{{ old('address2', $franchise->address2) }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <small id="success-message" class="text-success"
                                                                style="display:none;">ZIP codes updated
                                                                successfully.</small>
                                                            <small id="error-message" class="text-danger"
                                                                style="display:none;">Invalid ZIP code entered. Please enter
                                                                a valid 5-digit ZIP code.</small>
                                                            <small id="duplicate-message" class="text-warning"
                                                                style="display:none;">This ZIP code already exists.</small>
                                                ...
                                                <button type="submit" class="btn btn-primary bg-primary">Update
                                                    Franchise</button>
                                            </form>
                                        </div>
                                    </div>
