                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="filter-group">
                                    ...
                                    <select class="form-control  select2" id="statusFilter" data-placeholder="Select Status">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="filter-group">
                                    ...
                                    <select class="form-control filter-input select2" id="shippingAddressFilter" data-placeholder="Select Address">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="filter-group">
                                    ...
                                    <select class="form-control filter-input select2" id="flavorFilter" data-placeholder="Select Flavor">
