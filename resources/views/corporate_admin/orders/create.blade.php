    ...
    <div class="content-body default-height">
        <div class="container-fluid">
            <div class="form-head mb-4 d-flex flex-wrap align-items-center">
                <div class="me-auto">
                    <h2 class="font-w600 mb-0">Create New Order</h2>
                    <p>Create a new order for {{ $franchise->business_name }}</p>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="create-order-form"
                                action="{{ route('franchise.orders.store', ['franchise' => $franchiseId]) }}" method="POST">
                                @csrf
                                            ...
                                            <select name="franchise_id" id="franchise_id" class="form-control form-control-sm select2" required>
                                                ...
                                                @foreach($allFranchises as $franchiseOption)
                                                    <option value="{{ $franchiseOption->id }}" 
                                                        {{ $franchiseOption->id == $franchiseId ? 'selected' : '' }}
                                                ...
                                                <div class="card-body py-2">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="fw-bold" id="selected-franchise-info">{{ $franchise->business_name }}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            function initializeFranchiseDropdown() {
                ...
                if (franchiseSelect && typeof $ !== 'undefined' && $.fn.select2) {
                    ...
                    $('#franchise_id').on('select2:select', function (e) {
                        ...
                        if (form && franchiseId) {
                            const baseUrl = '{{ route("franchise.orders.store", ["franchise" => ":franchiseId"]) }}';
