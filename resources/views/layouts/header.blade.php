                ...
                <div class="header-left">
                    @if ($showDropdown && $currentRouteName != 'franchise.index')
                        <div class="w-100 ml-32"
                            @if (request()->route()->getName() !== 'franchise.dashboard') title="To switch franchises, navigate to the dashboard." @endif>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <select id="franchise-select" class="form-select select2 flex-grow-1"
                                    @if (request()->route()->getName() !== 'franchise.dashboard') disabled @endif
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            ...
                            <img src="{{ asset('assets/images/default_avatar.jpg') }}" width="20"
                                alt="Profile Picture">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            @role('franchise_admin')
                                <a href="{{ route('franchise.dashboard', ['franchise' => request()->route('franchise') ?? session('franchise_id')]) }}"
                                    class="dropdown-item ai-icon d-flex">
                                    <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary"
                                        width="18" height="18" viewBox="0 0 24 24" fill="none"
                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
