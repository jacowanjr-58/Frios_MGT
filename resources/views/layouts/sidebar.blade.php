...
<div class="deznav" style="margin-top:-8px;">
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            @canany(['customers.view', 'customers.create', 'customers.edit', 'customers.delete', 'customers.by_franchisee'])
            ...
            <li class="{{ Request::routeIs('events.*') ? 'mm-active' : '' }}">
                <a class="has-arrow ai-icon {{ Request::routeIs('events.*') ? 'active' : '' }}" href="javascript:void()"
        ...
        <a class="has-arrow ai-icon {{ Request::routeIs('franchise.events.*') ? 'active' : '' }}"
            href="javascript:void()" aria-expanded="{{ Request::routeIs('franchise.events.*') ? 'true' : 'false' }}">
            <i class="bi bi-calendar-week-fill"></i>
        ...
        <li class="{{ Request::routeIs('franchise_staff.sales.*') ? 'mm-active' : '' }}">
            <a class="ai-icon {{ Request::routeIs('franchise_staff.sales.*') ? 'active' : '' }}"
                href="{{ route('franchise_staff.sales.index', ['franchise' => $franchiseeId]) }}" aria-expanded="false">
        ...
        <ul aria-expanded="{{ Request::routeIs('franchise_staff.events.*') ? 'true' : 'false' }}"
            ...
            <li><a href="{{ route('franchise_staff.events.calendar', ['franchise' => $franchiseeId]) }}">Calender</a>
            </li>
            <li><a href="{{ route('franchise_staff.events.report', ['franchise' => $franchiseeId]) }}">Report</a>
            </li>
        </ul>
        </li>
        @endcanany --}}
