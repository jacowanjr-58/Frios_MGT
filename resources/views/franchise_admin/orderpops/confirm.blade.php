                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if (!empty($items))
                                <form id="stripe-payment-form" action="{{ route('franchise.orderpops.store', ['franchisee' => request()->route('franchisee')]) }}" method="POST">
                                    @csrf
                                                    ...
                                                    <table class="table mb-4 fs-14 card-table">
                                                        ...
                                                        <tbody>
                                                            @foreach ($items as $index => $item)
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <input type="hidden" name="items[{{ $index }}][fgp_item_id]"
                                                                                                                        value="{{ $item['id'] }}">
                                                                                                                    {{ $item['name'] }}
                                                                                                                </td>
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    <input type="number" name="items[{{ $index }}][unit_cost]"
                                                                                                                        ...
                                                                                                                        value="{{ old(" items.$index.unit_cost", $item['case_cost']) }}"
                                                                                                                        data-index="{{ $index }}">
                                                                                                                </td>
                                                                                                                <td>
                                            ...
                                            <td>
                                                ...
                                                <div class="mb-3">
                                                    <button type="button" class="btn btn-sm btn-outline-secondary"
                                                        onclick="autofillFranchisee()">Use Franchise Address</button>
                                                </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="mb-3">
                                            <label for="payment_reference" class="form-label">Payment Reference (if paid
                                                now)</label>
                                    ...
                                    <div class="mt-4">
                                        <button type="submit" id="submit-button"
                                            class="btn btn-danger btn-lg fw-bold shadow">Confirm Order</button>
                                    </div>
                                </form>
                            @else
