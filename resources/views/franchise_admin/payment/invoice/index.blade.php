    ...
    <script type="text/javascript">
        $(function () {
            var table = $('#invoice-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('franchise.invoice.index', request()->route('franchisee')) }}",
                columns: [
                    { data: 'order_num', name: 'order_num', defaultContent: '-' },
                ...
                drawCallback: function (settings) {
                    ...
                    $('.delete-invoice').on('click', function () {
                        var button = $(this);
                        var form = button.closest('.delete-invoice-form');
                        var invoiceNum = button.data('invoice-num');

                        Swal.fire({
                            title: 'Delete Invoice',
                            text: 'Are you sure you want to delete invoice #' + invoiceNum + '? This action cannot be undone.',
                            icon: 'warning',
