            ...
            <form action="{{ route('franchise.inventory.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                           ...
                           value="{{ old('stock_count_date', \Carbon\Carbon::now()->format('Y-m-d')) }}">
                    ...
                    <select name="locations_ID"
                        ...
                        @foreach($locations as $loc)
                            <option value="{{ $loc->locations_ID }}"
                                {{ old('locations_ID') == $loc->locations_ID ? 'selected' : '' }}>
                                {{ $loc->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('whole_sale_price_case') }}"
                           placeholder="0.00">
