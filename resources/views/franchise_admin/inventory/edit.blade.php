 ...
 <div class="content-body default-height">
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('franchise.inventory.update', $inventoryMaster->inventory_id) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                     ...
                     <!-- Wholesale Price Case -->
                        <div class="mb-3">
                            ...
                            <input type="text" name="whole_sale_price_case"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="retail_price_pop"
                        ...
                        <div class="d-flex align-items-end mb-3 gap-3">
                            <div>
                                <label class="form-label mb-0">Total Quantity <span class="text-danger">*</span></label>
                                <input type="number" id="total_quantity" name="total_quantity"
                                    class="form-control @error('total_quantity') is-invalid @enderror"
                                    value="{{ old('total_quantity', $inventoryMaster->total_quantity) }}" style="width: 6rem;">
                            ...
                            <div>
                                <label class="form-label mb-0">Split Quantity (Pops e.g.)</label>
                                <input type="number" name="split_total_quantity" class="form-control @error('split_total_quantity') is-invalid @enderror"
                                    value="{{ old('split_total_quantity', $inventoryMaster->split_total_quantity) }}" placeholder="Enter number"
                                    style="width: 6rem;">
                                @error('split_total_quantity')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="number" name="allocations[{{ $loc->locations_ID }}]"
                                            class="form-control allocation-input @error('allocations.' . $loc->locations_ID) is-invalid @enderror"
                                            value="{{ old('allocations.' . $loc->locations_ID, $defaultQty) }}" min="0">
                                        @error('allocations.' . $loc->locations_ID) <div class="text-danger">{{ $message
                                            }}</div> @enderror
                                    </td>
                                </tr>
                                @endforeach
