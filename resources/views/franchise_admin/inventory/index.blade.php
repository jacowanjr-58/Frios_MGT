            ...
            <div class="container-fluid">
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                        <a href="{{ route('franchise.inventory.create', ['franchisee' => request()->route('franchisee')]) }}"
                            class="btn btn-secondary btn-lg btn-block rounded text-white">+ New Item</a>
                    </div>
                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h3 class="mb-0 font-w600 fs-22">{{ $totalInventories }} Items</h3>
                                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive rounded">
                            <table id="inventory-table" class="table customer-table display mb-4 fs-14 card-table">
                                <thead>
                                    <tr>
                                        <th class="">Item</th>
                                        <th class="">Total on Hand</th>
                                        <th class="">Totals Breakdown</th>
                                        <th class="">Base Cost</th>
                                        <th class="">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
        ...
        <script>
            $(document).ready(function () {
                $('#inventory-table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('franchise.inventory.index', ['franchisee' => request()->route('franchisee')]) }}",
                    columns: [
                        { 
                            data: 'item_name', 
                            name: 'item_name',
                        ...
                        { 
                            data: 'totals_breakdown', 
                            name: 'totals_breakdown', 
                            className: 'text-left',
                            searchable: false
                        },
                        { 
                    ...
                    language: {
                        ...
                        // searchPlaceholder: "Enter item name or quantity...",
