			...
			<div class="container-fluid">
                ...
                <div class="row mb-4 align-items-center">
                    <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                        <a href="{{ route('franchise.customer.create', ['franchisee' => request()->route('franchisee')]) }}" class="btn btn-secondary btn-lg btn-block rounded text-white">+ New Customer</a>
                    </div>
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive rounded">
                            <table id="customers-table" class="table customer-table display mb-4 fs-14 card-table">
                                <thead>
                                    <tr>
                                        <th>Customer Name</th>
                                        <th>Email</th>
    ...
    <script>
        $(document).ready(function() {
            $('#customers-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('franchise.customer', ['franchisee' => request()->route('franchisee')]) }}",
                columns: [
                    { data: 'name', name: 'name' },
