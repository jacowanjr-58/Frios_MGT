                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                        ...
                                        <div class="media-body">
                                            <p class="mb-1 fs-12">Total Account</p>
                                            <h3 class="mb-0 font-w600 fs-22">{{ $accountCount }} Account</h3>
                                        </div>
                                    </div>
				...
				<div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive rounded">
                            <table id="example5" class="table account-table display mb-4 fs-14 card-table">
                                <thead>
                                    <tr>
