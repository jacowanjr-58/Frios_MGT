        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4 align-items-center">
                <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                    @can('expenses.create')
                        <a class="btn btn-secondary btn-lg btn-block rounded text-white" href="{{ route('franchise.expenses_by_franchise-create', ['franchise' => $franchiseId]) }}">All Expenses</a>
                    @endcan
                </div>
    ...
    <script>
        $(document).ready(function () {
            $('#expenses-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('franchise.expenses_by_franchise', ['franchise' => $franchiseId]) }}",
                columns: [
                    { data: 'name', name: 'name' },
