                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <form action="{{ route('franchise.expense-category.store') }}" method="POST">
                                            @csrf
                                            ...
                                            <button type="submit" class="btn btn-primary bg-primary">Add Expense
                                                Category</button>
                                        </form>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <form action="{{ route('franchise.expense-sub-category.store') }}"
                                            method="POST">
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    <label class="form-label">Sub Category Description <span
                                                            class="text-danger">*</span></label>
                                                    <textarea name="sub_category_description"
                                                        id="sub_category_description" cols="10" rows="5"
                                                        class="@error('sub_category_description') is-invalid @enderror form-control">{{ old('sub_category_description') }}</textarea>
                                                    @error('sub_category_description')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-primary bg-primary">Add Expense Sub
                                                Category</button>
                                        </form>
