    ...
    <div class="content-body default-height">
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-4 align-items-center">
                {{-- <div class="col-xl-3 col-lg-4 mb-4 mb-lg-0">
                    <a href="{{ route('franchise.expense-category.create') }}"
                        class="btn btn-secondary btn-lg btn-block rounded text-white">+ New Sub category</a>
                </div> --}}
                                ...
                                <div class="d-sm-flex d-block align-items-center">
                                    <div class="d-flex mb-sm-0 mb-3 me-auto align-items-center">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <h3 class="mb-0 font-w600 fs-22">{{ $expenseSubCategoryCount }} Sub Categories
                                            </h3>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive rounded">
                            <table id="expense-categories-table" class="table customer-table display mb-4 fs-14 card-table">
                                <thead>
                                    <tr>
                                        <th>Main Category</th>
                                        <th>Sub Category</th>
        ...
        @push('scripts')
            ...
            <script type="text/javascript">
                $(function () {
                    var table = $('#expense-categories-table').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: {
                        ...
                        drawCallback: function (settings) {
                            ...
                            $('.delete-expense-category').on('click', function () {
                                var button = $(this);
