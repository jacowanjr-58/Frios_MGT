                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        <form
                                            action="{{ route('franchise.expense-category.update' , ['franchisee' => $franchiseId, 'id' => $expenseSubCategory->id]) }}"
                                            method="POST">
                                            @method('PUT')
                                            @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="sub_category"
                                                        value="{{ $expenseSubCategory->sub_category }}"
                                                ...
                                                <div class="mb-3 col-md-12">
                                                    ...
                                                    <textarea name="sub_category_description"
                                                        ...
                                                        class="@error('sub_category_description') is-invalid @enderror form-control">{{ $expenseSubCategory->sub_category_description }}</textarea>
                                                    @error('sub_category_description')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            </div>
                                            <button type="submit" class="btn btn-primary bg-primary">Update Expense Sub
                                                Category</button>
                                        </form>
