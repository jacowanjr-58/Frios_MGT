...
class InvoiceController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $invoices = Invoice::where('franchisee_id', $franchisee)
                ->with('customer');
            ...
            return DataTables::of($invoices)
                ...
                ->addColumn('action', function($invoice) use ($franchisee) {
                    return '
                        <div class="d-flex">
        ...
        $data['invoiceCount'] = Invoice::where('franchisee_id', $franchisee)->count();
...
$data['allocations'] = \DB::table('inventory_allocations')
    ...
    public function destroy($franchisee, $id)
    {
        ...
        return redirect()
            ->route('franchise.invoice.index', ['franchisee' => $franchisee])
    ...
    public function show($franchisee, $id)
    {
        $invoice = Invoice::with('items.flavor')->findOrFail($id);
